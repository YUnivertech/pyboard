...
class Card (ttk.LabelFrame):
    ...
    def __init__ (self, _master, _uid, _name, _desc):
        ...
        Args:
            _master (_type_): _description_
            _uid (_type_): _description_
            _name (_type_): _description_
            _desc (_type_): _description_
        """
...
class AddProjectForm (GenericForm):
    ...
    Args:
        GenericForm (_type_): _description_
    """
    ...
    def __init__( self, _master, _name="Add project form" ):
        ...
        Args:
            _master (_type_): _description_
            _name (str, optional): _description_. Defaults to "Add project form".
        """
...
class EditProjectForm (GenericForm):
    ...
    def __init__ (self, _master, _name="Edit project form"):
        ...
        Args:
            _master (_type_): _description_
            _name (str, optional): _description_. Defaults to "Edit project form".
        """
...
class AddBoardForm (GenericForm):
    ...
    def __init__ (self, _master, _name="Add board form"):
        ...
        Args:
            _master (_type_): _description_
            _name (str, optional): _description_. Defaults to "Add board form".
        """
...
class EditBoardForm (GenericForm):
    ...
    def __init__ (self, _master, _name="Edit board form"):
        ...
        Args:
            _master (_type_): _description_
            _name (str, optional): _description_. Defaults to "Edit board form".
        """
...
class AddCardForm (ttk.LabelFrame):
    ...
    def __init__ (self, _master, _name="Add card form"):
        """_summary_

        Args:
            master (_type_): _description_
            name (str, optional): _description_. Defaults to "Add card form".
        """
        ...
        self.frame_in_canvas.bind (
            "<Configure>",
            lambda event: self.selection_canvas.configure (width=self.frame_in_canvas.winfo_width (),
            height=self.frame_in_canvas.winfo_height (),
            scrollregion=self.selection_canvas.bbox ("all")))

        self.selection_canvas.bind (
            consts.VERTICAL_MOUSE_MOTION,
            lambda event: scroll_canvas (event, self.selection_canvas, self.selection_scrollbar))
...
class EditProjectCardForm (ttk.LabelFrame):
    ...
    def __init__ (self, _master, _name="Edit project card"):
        """_summary_

        Args:
            _master (_type_): _description_
            _name (str, optional): _description_. Defaults to "Edit project card".
        """
...
class EditBoardCardForm (ttk.LabelFrame):
    ...
    def __init__ (self, _master, _name="Edit board card"):
        """_summary_

        Args:
            master (_type_): _description_
            name (str, optional): _description_. Defaults to "Edit board card".
        """
        ...
        self.frame_in_canvas.bind (
            "<Configure>",
            lambda event: self.tag_canvas.configure (width=self.frame_in_canvas.winfo_width (),
            height=self.frame_in_canvas.winfo_height (), scrollregion=self.tag_canvas.bbox ("all")))
...
def get_all_children (_widget):
    ...
    for child in _widget.winfo_children ():
...
def scroll_canvas (_event, _canvas:tk.Canvas, _scrollbar:ttk.Scrollbar):
    ...
    Args:
        _event (_type_): _description_
        _canvas (tk.Canvas): _description_
        _scrollbar (ttk.Scrollbar): _description_
    """
...
def generate_column (_name, _cards, _cards_frame):
    ...
    Args:
        _name (_type_): _description_
        _cards (_type_): _description_
        _cards_frame (_type_): _description_
    ...
    column_canvas.bind (
        consts.VERTICAL_MOUSE_MOTION,
        lambda event: scroll_canvas (event, column_canvas, column_scrollbar))
...
def edit_project_init ():
    ...
    # set
    # default to current name and desc
...
def update_state (_root_window):
    ...
    Args:
        _root_window (_type_): _description_
    """
    ...
    if cards_frame:
        ...
        cards_frame.columnconfigure ("all", weight=0)
...
connect_button                      = ttk.Button (
    ...
    text="Connect",
    command=lambda: connect (username_entry.get (),
    hostname_entry.get (),
    password_entry.get ()))
...
tag_dropdown                        = ttk.OptionMenu (
                                                        ...
                                                        command=lambda event: update_state (root))
